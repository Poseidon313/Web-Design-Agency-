var items = [
   '<a href="carwash.html"><div class="project-item"><div class="project-image"><img src="images/carwash.jpg" alt=""></div><div class="project-over project-over-s2"><div class="project-content"><h4>JPhotography</h4><p style="text-decoration: underline;">View Project</p></div></div></div></a>',
