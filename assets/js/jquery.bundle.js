  ...
  var T = {
    ...
    callback: function (f) {
      ...
      var A = [],
        ...
        M = 0;
      if (o)
        for (var L = k.getElementsByClassName("timeline-Tweet"); M < L.length; )
          L[M].getElementsByClassName("timeline-Tweet-retweetCredit").length > 0
            ? B.push(!0)
            : B.push(!1),
            (!B[M] || (B[M] && c)) &&
              (A.push(L[M].getElementsByClassName("timeline-Tweet-text")[0]),
              I.push(L[M].getAttribute("data-tweet-id")),
              s &&
                E.push(
                  C(L[M].getElementsByClassName("timeline-Tweet-author")[0])
                ),
              N.push(L[M].getElementsByClassName("dt-updated")[0]),
              z.push(
                L[M].getElementsByClassName("timeline-Tweet-timestamp")[0]
              ),
              void 0 !== L[M].getElementsByClassName("timeline-Tweet-media")[0]
                ? x.push(L[M].getElementsByClassName("timeline-Tweet-media")[0])
                : x.push(void 0)),
            M++;
      else
        for (L = _(k, "timeline-Tweet"); M < L.length; )
          _(L[M], "timeline-Tweet-retweetCredit").length > 0
            ? B.push(!0)
            : B.push(!1),
            (!B[M] || (B[M] && c)) &&
              (A.push(_(L[M], "timeline-Tweet-text")[0]),
              I.push(L[M].getAttribute("data-tweet-id")),
              s && E.push(C(_(L[M], "timeline-Tweet-author")[0])),
              N.push(_(L[M], "dt-updated")[0]),
              z.push(_(L[M], "timeline-Tweet-timestamp")[0]),
              void 0 !== _(L[M], "timeline-Tweet-media")[0]
                ? x.push(_(L[M], "timeline-Tweet-media")[0])
                : x.push(void 0)),
            M++;
      A.length > t &&
      ...
      if (w)
        for (; H < M; )
          j.push({
            ...
            author_data: {
              profile_url: E[H]
                ? E[H].querySelector('[data-scribe="element:user_link"]').href
                : null,
              profile_image: E[H]
                ? "https://twitter.com/" +
                  E[H].querySelector(
              ...
              profile_image_2x: E[H]
                ...
                : null,
              screen_name: E[H]
                ? E[H].querySelector('[data-scribe="element:screen_name"]')
                    .title
                : null,
              name: E[H]
                ? E[H].querySelector('[data-scribe="element:name"]').title
                : null,
            },
            time: N[H].textContent,
            timestamp: N[H].getAttribute("datetime")
              .replace("+0000", "Z")
        ...
        for (; H < M; ) {
          ...
          if (
            (i
              ? (g && (v(A[H]), s && v(E[H])),
                s && (O += '<div class="user">' + b(E[H].innerHTML) + "</div>"),
                (O += '<p class="tweet">' + b(A[H].innerHTML) + "</p>"),
                l &&
                  (O += h
                    ...
                    : '<p class="timePosted">' +
                      ...
                      "</p>"))
              : (A[H].textContent,
                s && (O += '<p class="user">' + E[H].textContent + "</p>"),
                (O += '<p class="tweet">' + A[H].textContent + "</p>"),
                l &&
                  (O += '<p class="timePosted">' + N[H].textContent + "</p>")),
            d &&
              (O +=
                ...
                (g ? ' target="_blank" rel="noopener">' : ">") +
                "Favorite</a></p>"),
            p && void 0 !== x[H] && void 0 !== y(x[H]))
          )
            for (var U = y(x[H]), D = 0; D < U.length; D++)
              O +=
...
!(function (t) {
  ...
  var a = function (e, a) {
    ...
    switch (
      ...
      (this.format = s.parseFormat(
        a.format || this.element.data("date-format") || "mm/dd/yyyy"
      )),
      (this.isInline = !1),
      (this.isInput = this.element.is("input")),
      (this.component =
        !!this.element.is(".date") && this.element.find(".add-on")),
      ...
      this.isRTL &&
        ...
        this.picker
          .find(".prev i, .next i")
          .toggleClass("ti-angle-left ti-angle-right")),
      ...
      a.startView || this.element.data("date-start-view"))
    ) {
      case 2:
      case "decade":
    ...
    (this.todayBtn = a.todayBtn || this.element.data("date-today-btn") || !1),
      (this.todayHighlight =
        a.todayHighlight || this.element.data("date-today-highlight") || !1),
      (this.weekStart =
        (a.weekStart ||
          this.element.data("date-weekstart") ||
          i[this.language].weekStart ||
          0) % 7),
      ...
      this.setDaysOfWeekDisabled(
        a.daysOfWeekDisabled || this.element.data("date-days-of-week-disabled")
      ),
      this.fillDow(),
      this.fillMonths(),
      this.update(),
  ...
  (a.prototype = {
    ...
    _attachEvents: function () {
      ...
      for (var e, a, i = 0; i < this._events.length; i++)
        (e = this._events[i][0]), (a = this._events[i][1]), e.on(a);
    },
    _detachEvents: function () {
      for (var t, e, a = 0; a < this._events.length; a++)
        (t = this._events[a][0]), (e = this._events[a][1]), t.off(e);
      this._events = [];
    },
    show: function (e) {
      this.picker.show(),
    ...
    getFormattedDate: function (t) {
      return (
        void 0 === t && (t = this.format),
        s.formatDate(this.date, t, this.language)
      );
    },
    ...
    update: function () {
      ...
      ("string" == typeof arguments[0] || arguments[0] instanceof Date)
        ...
        (this.date = s.parseDate(t, this.format, this.language)),
        e && this.setValue();
      var a = this.viewDate;
      this.date < this.startDate
        ...
        a &&
          a.getTime() != this.viewDate.getTime() &&
    ...
    fill: function () {
      var a = new Date(this.viewDate),
        ...
        h = a.getUTCMonth(),
        r =
          this.startDate !== -1 / 0 ? this.startDate.getUTCFullYear() : -1 / 0,
      ...
      this.picker
        ...
        .text(i[this.language].months[h] + " " + n),
        this.picker
          .find("tfoot th.today")
          .text(i[this.language].today)
      ...
      u.setUTCDate(f),
        u.setUTCDate(f - ((u.getUTCDay() - this.weekStart + 7) % 7));
      var v = new Date(u);
      v.setUTCDate(v.getUTCDate() + 42), (v = v.valueOf());
      for (var g, m = []; u.valueOf() < v; )
        u.getUTCDay() == this.weekStart && m.push("<tr>"),
          (g = ""),
          u.getUTCFullYear() < n ||
          (u.getUTCFullYear() == n && u.getUTCMonth() < h)
            ? (g += " old")
            : (u.getUTCFullYear() > n ||
                (u.getUTCFullYear() == n && u.getUTCMonth() > h)) &&
              (g += " new"),
          this.todayHighlight &&
            u.getUTCFullYear() == p.getFullYear() &&
            u.getUTCMonth() == p.getMonth() &&
            u.getUTCDate() == p.getDate() &&
            (g += " today"),
          c && u.valueOf() == c && (g += " active"),
          (u.valueOf() < this.startDate ||
            u.valueOf() > this.endDate ||
            -1 !== t.inArray(u.getUTCDay(), this.daysOfWeekDisabled)) &&
            (g += " disabled"),
          m.push('<td class="day' + g + '">' + u.getUTCDate() + "</td>"),
          u.getUTCDay() == this.weekEnd && m.push("</tr>"),
      ...
      var D = this.date && this.date.getUTCFullYear(),
        y = this.picker
          ...
          .find("span")
          .removeClass("active");
      D && D == n && y.eq(this.date.getUTCMonth()).addClass("active"),
        (n < r || n > d) && y.addClass("disabled"),
        n == r && y.slice(0, o).addClass("disabled"),
        n == d && y.slice(l + 1).addClass("disabled"),
        (m = ""),
    ...
    updateNavArrows: function () {
      ...
      switch (this.viewMode) {
        ...
        case 1:
        case 2:
          this.startDate !== -1 / 0 && e <= this.startDate.getUTCFullYear()
            ? this.picker.find(".prev").css({ visibility: "hidden" })
            : this.picker.find(".prev").css({ visibility: "visible" }),
            this.endDate !== 1 / 0 && e >= this.endDate.getUTCFullYear()
              ? this.picker.find(".next").css({ visibility: "hidden" })
              : this.picker.find(".next").css({ visibility: "visible" });
      }
    },
        ...
        switch (i[0].nodeName.toLowerCase()) {
          case "th":
            switch (i[0].className) {
              ...
              case "today":
                var h = new Date();
                (h = e(h.getFullYear(), h.getMonth(), h.getDate(), 0, 0, 0)),
                  this.showMode(-2);
            ...
            if (i.is(".day") && !i.is(".disabled")) {
              ...
              i.is(".old")
                ? 0 === o
                  ? ((o = 11), (d -= 1))
                  : (o -= 1)
                : i.is(".new") && (11 == o ? ((o = 0), (d += 1)) : (o += 1)),
                this._setDate(e(d, o, l, 0, 0, 0, 0));
            }
        }
    },
    _setDate: function (t, e) {
      ...
      (e && "date" != e) || (this.date = t),
        ...
        a && (a.change(), !this.autoclose || (e && "date" != e) || this.hide());
    },
      ...
      if (this.picker.is(":not(:visible)")) 27 == t.keyCode && this.show();
        ...
        switch (t.keyCode) {
          ...
          case 39:
            ...
            (e = 37 == t.keyCode ? -1 : 1),
              t.ctrlKey
                ? ((a = this.moveYear(this.date, e)),
                  (i = this.moveYear(this.viewDate, e)))
                : t.shiftKey
                ? ((a = this.moveMonth(this.date, e)),
                  (i = this.moveMonth(this.viewDate, e)))
                : ((a = new Date(this.date)).setUTCDate(
                    this.date.getUTCDate() + e
                  ),
                  (i = new Date(this.viewDate)).setUTCDate(
                    this.viewDate.getUTCDate() + e
                  )),
            ...
            (e = 38 == t.keyCode ? -1 : 1),
              t.ctrlKey
                ...
                ? ((a = this.moveMonth(this.date, e)),
                  (i = this.moveMonth(this.viewDate, e)))
                : ((a = new Date(this.date)).setUTCDate(
                    this.date.getUTCDate() + 7 * e
                  ),
                  (i = new Date(this.viewDate)).setUTCDate(
                    this.viewDate.getUTCDate() + 7 * e
                  )),
              this.dateWithinRange(a) &&
                ((this.date = a),
                (this.viewDate = i),
    ...
    showMode: function (t) {
      t && (this.viewMode = Math.max(0, Math.min(2, this.viewMode + t))),
        this.picker
          .find(">div")
          .hide()
          .filter(".datepicker-" + s.modes[this.viewMode].clsName)
          .css("display", "block"),
        this.updateNavArrows();
    },
  }),
      ...
      return (
        ...
        this.each(function () {
          ...
          n ||
            s.data(
              "datepicker",
              (n = new a(this, t.extend({}, t.fn.datepicker.defaults, h)))
            ),
            "string" == typeof e &&
              "function" == typeof n[e] &&
              n[e].apply(n, i);
  ...
  var i = (t.fn.datepicker.dates = {
    ...
    s = {
      ...
      parseDate: function (s, n, h) {
        ...
        if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(s)) {
          ...
          for (var l = 0; l < d.length; l++)
            switch (((u = o.exec(d[l])), (r = parseInt(u[1])), u[2])) {
              case "d":
        ...
        if (
          ...
          for (var D = m.length; l < D; l++) {
            if (((c = parseInt(d[l], 10)), (u = m[l]), isNaN(c)))
              switch (u) {
                case "MM":
          ...
          var y;
          for (l = 0; l < v.length; l++)
            (y = v[l]) in f && !isNaN(f[y]) && g[y](s, f[y]);
        }
        return s;
      },
      formatDate: function (e, a, s) {
        ...
        e = [];
        for (
          var h = t.extend([], a.separators), r = 0, o = a.parts.length;
          r < o;
          r++
        )
          h.length && e.push(h.shift()), e.push(n[a.parts[r]]);
        return e.join("");
      },
      headTemplate:
        '<thead><tr><th class="prev"><i class="ti-angle-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="ti-angle-right"/></th></tr></thead>',
    ...
    (YTPlayer = {
      ...
      init: function (a, n) {
        ...
        return (
          ...
          (d.defaults.events = {
            onReady: function (e) {
              d.onPlayerReady(e),
                d.options.pauseOnScroll && d.pauseOnScroll(),
                "function" == typeof d.options.callback &&
                  d.options.callback.call(this);
            },
            onStateChange: function (e) {
              1 === e.data
                ? (d.$node.find("img").fadeOut(400), d.$node.addClass("loaded"))
                : 0 === e.data &&
                  d.options.repeat &&
                  d.player.seekTo(d.options.start);
            },
          }),
          (d.options = e.extend(!0, {}, d.defaults, d.userOptions)),
          (d.options.height = Math.ceil(d.options.width / d.options.ratio)),
          (d.ID = new Date().getTime()),
          (d.holderID = "YTPlayer-ID-" + d.ID),
          d.options.fitToBackground
            ? d.createBackgroundVideo()
            : d.createContainerVideo(),
          d.$window.on("resize.YTplayer" + d.ID, function () {
            d.resize(d);
          }),
          (l = d.onYouTubeIframeAPIReady.bind(d)),
      ...
      resize: function (o) {
        ...
        var a,
          ...
          s = e("#" + o.holderID);
        l / o.options.ratio < r
          ? ((a = Math.ceil(r * o.options.ratio)),
            s
              .width(a)
              .height(r)
              .css({ left: (l - a) / 2, top: 0 }))
          : ((n = Math.ceil(l / o.options.ratio)),
            s
              .width(l)
              .height(n)
              .css({ left: 0, top: (r - n) / 2 })),
          (s = null),
          (i = null);
      },
      ...
      (e.fn.scrollStopped = function (t) {
        ...
        o.scroll(function () {
          o.data("scrollTimeout") && clearTimeout(o.data("scrollTimeout")),
            o.data("scrollTimeout", setTimeout(t, 250, i));
        });
      }),
